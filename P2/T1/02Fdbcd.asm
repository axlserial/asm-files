;  Programa que lee 2 números decimales de 10 digitos, y los suma considerando acarreo

.MODEL SMALL

extrn lee2:near                     ; Func que leerá 2 digitos del núm
...
main:   mov ax, @data
 ...
 suma2: mov ax, 0h                  ; inicializa 'ax' en 0
        ...
        daa                         ; ajusta el resultado a base 10
