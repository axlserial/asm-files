...
; mismo programa que el 08, pero ahora usando PUSH y POP para salvar/restaurar el número
...
main:  mov ax, @data               ; Obtiene la dirección de DATA (segm de datos)
       ...
       push ax                     ; resguarda el núm en la pila
       call espa                   ; llama a func que imprime un espacio
       pop ax                      ; regresa el núm de la pila a 'ax'
