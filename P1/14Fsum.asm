; Programa que lee y suma dos números hexadecimales y muestra el resultado en bin y hex
...
main:  mov ax, @data               ; Obtiene la dirección de DATA (segm de datos)
       ...
       mov cl, al                  ; guarda el núm leído
       call lee2                   ; lee el segundo núm
       add al, cl                  ; suma los dos núm y se guarda en 'al' 
